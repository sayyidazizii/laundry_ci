...
<body>  
    <div class="container">
    <div class="container w-50" style="position:relative;margin-top:10%;display: flex;align-items: centnter;justify-content:center">
        <div class="card text">
            <div class="card-body">
            <form action="<?php echo site_url()?>/Login/validasi" method="POST">
                ...
                <?php if (isset($pesan)):?>
                    <div class="alert alert-danger">
                        <strong>Login Gagal!</strong>password dan username salah
                    </div>
                <?php endif?>
                <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <a class="text-primary" href="<?php echo site_url()?>/Register/index">Register</a>
                    </div>
                </div>
            </form>
        </div>
