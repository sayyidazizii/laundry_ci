...
<head>
    ...
    <title>Laundry Member Regis</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <?php if (isset($pesan)):?>
                                        <div class="alert alert-danger">
                                            <strong>Daftar Gagal!</strong>password dan username sudah ada
                                        </div>
                                    <?php endif?>
                                    <form class="user" action="<?php echo site_url()?>/Frontend/Regis" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Buat Password">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="alamat" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Tambah Alamat pelanggan">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="nohp" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Tambahkan No hp">
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-user btn-block">Sign Up</button>
                                        <hr>
                                    </form>
                                    <div class="text-center">
                                        <a class="small text-left" href="<?php echo base_url('Frontend')?>">Sign In!</a>
                                        <span>_________</span>
